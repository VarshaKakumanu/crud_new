...
class WPBakeryShortCode_ts_services_image extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		ob_start();
		?>
        <div class="annusa-image-wrapper">
...
vc_map( array(
	"base" 			    => "ts_services_image",
	"name" 			    => __( 'Services Image', 'themezinho' ),

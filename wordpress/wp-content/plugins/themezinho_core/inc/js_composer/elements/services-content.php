...
class WPBakeryShortCode_ts_services_content extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		?>
		<div class="services-content <?php echo esc_attr( $wrapper_class ); ?>" <?php if( $animate_block == 'yes' && $animation_delay != '' ) { echo 'data-wow-delay="' . esc_attr( $animation_delay ) . '"'; } ?>>
...
vc_map( array(
	"base" 			    => "ts_services_content",
	"name" 			    => __( 'Services Content', 'themezinho' ),
